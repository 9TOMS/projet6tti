...
--
-- Hôte : localhost
-- Généré le : jeu. 05 juin 2025 à 11:04
...
(132, 9, 2, 'yuab', '2025-05-24 13:10:17');
...
CREATE TABLE `news` (
  ...
  `Media_Type` varchar(20) DEFAULT 'google_slides'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `commentaires_news`
  MODIFY `Id_Commentaire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;
