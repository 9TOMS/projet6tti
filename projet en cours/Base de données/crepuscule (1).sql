...
--
-- Hôte : localhost
-- Généré le : jeu. 03 avr. 2025 à 10:44
...
CREATE TABLE `membre` (
  ...
  `Stage_Inscri_Membre` text NOT NULL,
  `Stage_Payer_Membre` int(11) NOT NULL,
  `Cours_Inscri_Membre` text NOT NULL,
  `Cours_Payer_Membre` int(11) NOT NULL,
  `Balade_Inscri_Membre` text NOT NULL,
  `Balade_Payer_Membre` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
