...
function ajusterHauteur() {
    iframe = document.querySelector("pdfnews");
    iframe.style.height = iframe.offsetWidth * 0.5625 + "px"; // Ratio 16:9 (0.5625)

    iframe = document.querySelector("pdfnews2");
    iframe.style.height = iframe.offsetWidth * 1 + "px"; // Ratio 16:9 (0.5625)
}

window.addEventListener("resize", ajusterHauteur);
document.addEventListener("DOMContentLoaded", ajusterHauteur);